...
public class Lugar {
	...
	/**
	 * Adiciona uma avaliacao na lista de avaliações do lugar
	 * @param avaliacao
	 * @throws Exception
	 */
	public void addAvaliacao(int avaliacao) throws Exception{
		if(avaliacao < 0 || avaliacao > 5) {
			throw new RuntimeException("Avaliação dever ter de 1 a 5 estrelas");
		}
	...
	/**
	 * Calcula o total de avaliaçoes que o lugar teve
	...
	/**
	 * Calcula a doma de todas as avaliações que o lugar teve
